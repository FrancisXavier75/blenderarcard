...
function show_warning(id) {
  setCSSRuleStyle('display', 'block', 'warning_center', false, '');
  setCSSRuleStyle('display', 'block', id, false, '');
  registerSetTimeout(3, function() {
    setCSSRuleStyle('display', 'none', 'warning_center', false, '');
    setCSSRuleStyle('display', 'none', id, false, '');
  });
}
...
createCSSRule('.warning-center', "position: absolute; width: 100%; height: 50px; top: 50%; margin-top: -25%; left: 0px; display: none;", false, '');
addHTMLElement('div', 'warning_center', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'warning-center', 'warning_center', false);
createCSSRule('.warning_AR_unavailable', "position: absolute; width: 242px; height: 50px; left: 50%; margin-left: -121px; display: none;", false, '');
addHTMLElement('div', 'warning_AR_unavailable', 'TO', 'warning_center', false);
setHTMLElemAttribute('className', 'warning_AR_unavailable', 'warning_AR_unavailable', false);
...
createCSSRule('.info-button', "position: absolute; width: 50px; height: 50px; z-index: 1; top: 10px; right: 10px; background-repeat: no-repeat; display: block; overflow: hidden; border-style: none; border-color: #000000; color: #000000; cursor: pointer;", false, '');
addHTMLElement('a', 'info_button', 'TO', ['CONTAINER'], false);
setHTMLElemAttribute('className', 'info-button', 'info_button', false);
setHTMLElemAttribute('href', 'https://xavier.com', 'info_button', false);
...
operateAnimation('PLAY', 'xavier_armature', 0, 45, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('xavier_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'xavier_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'xavier_armature', 46, 190, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'Xavier_group'], false);
      ...
      changeVis(['GROUP', 'Xavier_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('xavier_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('xavier_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('xavier_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'xavier.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'Xavier_group'], true);
  changeVis(['GROUP', 'indicator_group'], false);
  setObjTransform('xavier_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('xavier_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnClick('edit_button', false, false, [0,1,2], function() {
  registerSetTimeout(0.1, function() {
    changeVis(['GROUP', 'Xavier_group'], true);
    changeVis(['drag_move', 'drag_scale', 'drag_rotate', 'ready_button', 'scale_percentage'], true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('xavier_armature', 'XY', 'WORLD', 'M)QqA2{BJ7(-f*CQ/?;w', 'Q4xHbp9|I0?stgOlCZ7L');
}, function() {}, 'Q4xHbp9|I0?stgOlCZ7L');

registerOnClick('ready_button', false, false, [0,1,2], function() {
  registerSetTimeout(0.1, function() {
    changeVis(['drag_move', 'drag_scale', 'drag_rotate', 'ready_button', 'scale_percentage'], false);
    changeVis('edit_button', true);
    changeVis(['GROUP', 'indicator_group'], true);
    changeVis(['GROUP', 'Xavier_group'], false);
    mode = 'indicator';
...
registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('xavier_armature', 'Z', 'WORLD', 'rS?0X**3vHM)4pS8rV]4', 'LICYkpxX!Q)^11?u(P|Y');
}, function() {}, 'LICYkpxX!Q)^11?u(P|Y');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('xavier_armature', 'Z', ',~7A-YDf.XM0|+hhBM@!', 'HH;prrl`d_Ikl9{z7IOq');
  dragScale('xavier_armature', 'X', 'odTA?!TgomQqJvj^*F8o', 'HH;prrl`d_Ikl9{z7IOq');
  dragScale('xavier_armature', 'Y', 'B/Un.5JF5so/hJ.IQp+m', 'HH;prrl`d_Ikl9{z7IOq');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('xavier_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'HH;prrl`d_Ikl9{z7IOq');
